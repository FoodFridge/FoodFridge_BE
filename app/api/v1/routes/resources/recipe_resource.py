...
class GenerateRecipeFromIngredientsWithGoogle(Resource):
    def post(self):
        try:
            ...
            url = f"https://www.googleapis.com/customsearch/v1?key={api_key}&cx=e21c2f9ab0e304589&q={ingredients}"
            payload = {}
            headers = {}
            ...
            if status_code == 200:
                ...
                # Count the number of items in recipe_data
                count_items = len(recipe_data)

                print("Number of items in recipe_data:", count_items)
                return {"success": True, "recipes": recipe_data}
